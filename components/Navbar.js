  ...
  return (
    <nav className='bg-red-500 flex text-black font-semibold text-sm justify-between items-center px-8 py-2'>
        ...
        <ul className='flex gap-6 items-center '>
            ...
            <Link href='/generate'><li>URL Shortner</li></Link>
            ...
            <Link href='https://github.com/prabal-007/biturls' target='__blank'><button className='bg-red-300 px-3 py-1 rounded-lg hover:bg-red-200 '>GitHub</button></Link>
            </li>
        </ul>
    </nav>
  )
